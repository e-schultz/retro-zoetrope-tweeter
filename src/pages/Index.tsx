...
import { Terminal, Hash, Search, UserCircle, BarChart4, Settings } from 'lucide-react';
      ...
      <div className="min-h-screen bg-terminal-black flex flex-col items-center justify-center text-terminal-green font-mono">
        <div className="w-full max-w-2xl">
          <div className="mb-8 flex items-center justify-center">
            <div className="text-5xl font-display tracking-wide neon-text mb-2 relative" style={{ "--neon-color": "#b14aed" } as React.CSSProperties}>
